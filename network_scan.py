...
class States_Singleton:
    ...
    def get_history(self, size_in_bytes: int = 2000):
        # return a good history record

    def set_history(self, new_history):
        # update the history

    def serialize_to_file(self, filepath="/tmp/olddog.term.md"):
        # put context to /tmp/ file, the name is funny olddog, it's ok for now
